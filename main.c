...
void batalha(Jogo *jogo){
    ...
    while (pokemon1->vida > 0 && pokemon2->vida > 0) {
        ...
        // Mostra o ataque usado pelo pokemon e a vida do defensor após o ataque
        ...
        if (pokemon1->vida <= 0) {
            ...
            return;
        } else if (pokemon1->vida <= 0 && pokemon2->vida <=0){
